...
export default function AdminLayout() {
    ...
    const menuItems = [
      ...
      { id: 'usermanagement', label: 'User Management', icon: Users, component: UserManagement },
      { id: 'filemanagement', label: 'File Management', icon: FileText, component: FileManagement },
    ];
